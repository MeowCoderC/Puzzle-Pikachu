...
namespace DG.Tweening
{
    ...
    public static class DOTweenCYInstruction
    {
        ...
        {
            public override bool keepWaiting => this.t.active && (!this.t.playedOnce || this.t.position * (this.t.CompletedLoops() + 1) > 0);
        ...
        {
            public override bool keepWaiting => this.t.active && this.t.position * (this.t.CompletedLoops() + 1) < this.position;
